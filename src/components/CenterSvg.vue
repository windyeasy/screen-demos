...
<template>
  <div class="center-svg w-full h-full">
    <svg
      id="dongxiao"
      data-name="dongxiao"
    ...
    >
      <defs>
        ...
        >
          ...
          <feComposite result="composite-2" />
          <feComposite result="composite-3" />
          <feFlood result="flood" flood-color="#f58b02" flood-opacity="0.9" />
          <feComposite result="composite-4" operator="in" in2="composite-3" />
          <feBlend result="blend" in2="SourceGraphic" />
          <feBlend result="blend-2" in="SourceGraphic" />
        </filter>
      ...
      <template v-for="item in [1, 2, 3]" :key="item">
        ...
        <circle
          ...
          r="3"
        >
          <animateMotion dur="6s" begin="-3s" rotate="auto" repeatCount="indefinite">
            <mpath :href="`#line_b_${item}`" />
          </animateMotion>
        </circle>
        <!-- orange -->
        <circle
          class="cur-cls-orange"
          cx="0"
          cy="0"
          r="3"
        >
    ...
    <!-- 烟花特效 -->
    <img class="firework fireworkA" src="../assets/images/ling/lingxA.png">
    <img class="firework fireworkB" src="../assets/images/ling/lingxB.png">
    <img class="firework fireworkC" src="../assets/images/ling/lingxC.png">
    <img class="firework fireworkD" src="../assets/images/ling/lingxD.png">
    <img class="firework fireworkE" src="../assets/images/ling/lingxE.png">
    <img class="firework fireworkF" src="../assets/images/ling/lingxF.png">
  </div>
</template>
...
/* 图标动画 */
#icon-start-guangzhou,
#icon-pie-shenzhen,
#icon-earth-dongguan {
  animation: icon-move 1.4s linear infinite;
}
...
.fireworkA {
  top: 30%;
  left: 47%;
  animation: fire1 2s linear infinite;
}

.fireworkB {
  top: 35%;
  left: 58%;
  animation: fire2 2s ease-in infinite;
}

.fireworkC {
  top: 40%;
  left: 40%;
  animation: fire3 2s ease-in-out infinite;
}
